...
Template.dialogTest.events
  ...
  'click #info': ->
    CoffeeAlerts.info """
      A <strong>very long</strong> informational message about something the user may be interested in.<br/>
      Or not ...
    """

  'click #warning': ->
    CoffeeAlerts.warning("Warning Test")

  'click #error': ->
    CoffeeAlerts.error("Error Test")
